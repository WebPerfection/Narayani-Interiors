              ...
              <div className="product-info">
                <div className="product-text">
                  ...
                  <span>
                    ...
                    <p>{user.consult_status ? 'Consulted' : 'Not Consulted'}</p>
                  </span>
                  <span>
            ...
            <div className="popup-inner">
              ...
              <form onSubmit={handleUpdateFormSubmit}>
                ...
                <input
                  ...
                  disabled={consultStatus && new Date(nextConsultDate) >= new Date().setHours(0,0,0,0)} // Disable if Consult Status is "Consulted" and date is not in the past
                  required
                />
